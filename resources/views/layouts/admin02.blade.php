...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{ asset('admin/images/coins/00.png') }}" />
    <link rel="stylesheet" href="{{ asset('admin/css/core/libs.min.css') }}">
    <link rel="stylesheet" href="{{ asset('admin/css/coinex.mine209.css?v=1.0.0') }}">
    <link rel="stylesheet" href="{{ asset('admin/css/custom.mine209.css?v=1.0.0') }}">
...
<body class=" ">
    ...
    <aside class="sidebar sidebar-default navs-rounded ">
        <div class="sidebar-header d-flex align-items-center justify-content-start">
            <a href="/dashboard" class="navbar-brand dis-none align-items-center">
                <h4 class="logo-title m-0">{{ env('APP_NAME') }} Admin</h4>
            </a>
                ...
                <ul class="navbar-nav iq-main-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/admin/deposit/history">
                            ...
                            <span class="item-name"> Deposit Funds</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/admin/pending_earnings">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4"
                                        d="M13.3051 5.88243V6.06547C12.8144 6.05584 12.3237 6.05584 11.8331 6.05584V5.89206C11.8331 5.22733 11.2737 4.68784 10.6064 4.68784H9.63482C8.52589 4.68784 7.62305 3.80152 7.62305 2.72254C7.62305 2.32755 7.95671 2 8.35906 2C8.77123 2 9.09508 2.32755 9.09508 2.72254C9.09508 3.01155 9.34042 3.24276 9.63482 3.24276H10.6064C12.0882 3.2524 13.2953 4.43736 13.3051 5.88243Z"
                            ...
                            <span class="item-name"> Pending Earnings

                                @if (pendingEarning() > 0)
                                    <span class="bg-soft-warning rounded p-1 px-2   ">
                                        <b> {{ pendingEarning() }}</b>
                    ...
                    <li class="nav-item ">
                        <a class="nav-link" aria-current="page" href="/admin/airdrops">
                            <i class="icon">
                                <svg width="22" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M9.15722 20.7714V17.7047C9.1572 16.9246 9.79312 16.2908 10.581 16.2856H13.4671C14.2587 16.2856 14.9005 16.9209 14.9005 17.7047V17.7047V20.7809C14.9003 21.4432 15.4343 21.9845 16.103 22H18.0271C19.9451 22 21.5 20.4607 21.5 18.5618V18.5618V9.83784C21.4898 9.09083 21.1355 8.38935 20.538 7.93303L13.9577 2.6853C12.8049 1.77157 11.1662 1.77157 10.0134 2.6853L3.46203 7.94256C2.86226 8.39702 2.50739 9.09967 2.5 9.84736V18.5618C2.5 20.4607 4.05488 22 5.97291 22H7.89696C8.58235 22 9.13797 21.4499 9.13797 20.7714V20.7714"
                            ...
                            <span class="item-name">Manage Airdrops</span>
                        </a>
                    </li>
    ...
    <!-- GSAP Animation JS-->
    <script src="{{ asset('admin/vendor/gsap/gsap.min.js') }}"></script>
    <script src="{{ asset('admin/vendor/gsap/ScrollTrigger.min.js') }}"></script>

    <!-- fslightbox JavaScript -->
    <script src="{{ asset('admin/js/fslightbox.js') }}"></script>

    <!-- Mapchart JavaScript -->
    <script src="{{ asset('admin/js/charts/vector-chart.js') }}"></script>
    <script src="{{ asset('admin/js/charts/dashboard.js') }}"></script>

    <!-- app JavaScript -->
    <script src="{{ asset('admin/js/coinex.js') }}"></script>

    <!-- apexchart JavaScript -->
    <script src="{{ asset('admin/js/charts/apexcharts.js') }}"></script>

    <!-- Gsap Animation Init -->
    <script src="{{ asset('admin/js/gsap.js') }}"></script>
