...
class UserController extends Controller
{
    ...
    {
        $deposits = AdminCredit::where(['user_id' => auth()->user()->id])->orderby('id', 'desc')->paginate(10);
        $coin = CoinInfo::first();
    ...
    function withdrwal()
    {
        ...
        return view('mobile.withdrawal', compact(['usdt_balance', 'withdrawals']));
    }
    ...
    function transferIndex()
    {
        ...
        return view('mobile.transfer', compact(['transfers', 'usdt_balance', 'user']));
    }
    ...
    function transfer(Request $request)
    {
        ...
        $val = Validator::make($request->all(), [
            ...
            'receiver' => 'required|string|exists:users,wallet',
        ...
        $user_id = User::where('wallet', $request->receiver)->first()->id;

        // if ($request->wallet_type == 'coin') {
        // transfer to normal real wallet
        ...
        // }
        return back()->with('success', 'USDT have been transfered!');
    }
